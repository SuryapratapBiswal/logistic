    ...
    return (
        <>
            ...
            <footer className="px-4 py-10 bg-gray-50">
                ...
                <div className="flex flex-col md:flex-row md:items-center mt-16 md:justify-between">
            ...
            <span className="font-bold capitalize text-[#7c3aed]">
              Project management system
                    ...
                    <div className="mt-4 grow md:ml-12 md:mt-0">
                        <p className="text-base font-semibold text-gray-700">
                            © 2024 Luminous Infoways Pvt.Ltd . All Rights Reserved
                        </p>
                    </div>
                </div>
            </footer>
